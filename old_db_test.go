...
*/
func getDbSessionForTestOld() *mgo.Session {
...
/*
create, retrieve, update, delete applications from database.
*/
func TestCRUDApplicationsOld(t *testing.T) {

	// initialize db connection / session
	session := getDbSessionForTestOld()
